  ...
  return (
    <Form>
      <Row>
        ...
        <Col span={24}>
          <Link to="/title-auths"><Button type="primary" size="large" style={{ marginLeft: '30px' }}>返回</Button></Link>
...
export default Form.create()(DoctorTitleModal)
