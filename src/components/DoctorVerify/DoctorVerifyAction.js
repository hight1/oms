        ...
        <Col span={5} style={{ textAlign: '' }} />
        {
          searchMode === 'simple' && (
            <Col span={19} style={{ textAlign: 'right', display: 'inline' }}>
              <Radio.Group style={{ marginRight: '10px' }} defaultValue={1} value={type} onChange={handleChange}>
...
export default DoctorVerifyAction
