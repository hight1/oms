...
import { queryVcPrice, query, create, update, deny, remove, batchRemove, queryDoctorTitle } from '../services/doctorProfile'
import { getLocalStorageJson } from '../utils/storage'

export default modelExtend(pageModel, {

  namespace: 'doctorProfile',
  ...
  subscriptions: {
    setup ({ dispatch, history }) {
      history.listen((location) => {
        const match = pathToRegexp('/doctor-profiles').exec(location.pathname)
        if (match) {
