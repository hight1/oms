...
import { query, queryUser, create, update, remove, batchRemove } from '../services/patient'
  ...
  subscriptions: {
    setup ({ dispatch, history }) {
      history.listen((location) => {
        const match = pathToRegexp('/patients').exec(location.pathname)
        const match2 = pathToRegexp('/patients/edit/:cdoe').exec(location.pathname)
        if (match) {
