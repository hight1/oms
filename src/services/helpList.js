...
const { api } = config
const { updateHelp, helpCate, helpList, isCateTop, isTop, createHelp, queryChildDepts, hospitals, department, departments, grantRoles, denyUser } = api
 ...
 * @param {*} params
 */
export async function CateTop (params) {
  return request({
    url: isCateTop,
    method: 'put',
    data: params,
 ...
 * @param {*} params
 */
export async function queryHelpCate (params) {
  return request({
    url: helpCate,
    method: 'get',
    data: params,
