...
const { api } = config
const { replyQues, orderCancel, questions, user, createDepartment, queryChildDepts, hospitals, department, departments, grantRoles, denyUser } = api
 ...
 * @param {*} params
 */
export async function queryMe (params) {
  return request({
    url: user,
    method: 'get',
    data: params,
